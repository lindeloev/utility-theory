...
Let's define a function which returns the utility associated with a set of predictors. Note that we can define costs on all terms in the model (here `sessions` and `success`):
```{r}
